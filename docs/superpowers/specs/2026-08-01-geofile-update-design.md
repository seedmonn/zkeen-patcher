...
|---|---|---|---|---|---|
| 1 | `MSK` | `xui` | `root@77.105.169.97:22` (ключ) | `/usr/local/x-ui/bin` | API `restartXrayService` |
| 2 | `SPB` | `xui` | `seedmon@212.67.12.230:53908` (ключ) | `/usr/local/x-ui/bin` | API `restartXrayService` |
| 3 | `EST` | `xui` | `seedmon@38.180.164.100:53908` (ключ) | `/usr/local/x-ui/bin` | API `restartXrayService` |
...
|---|---|---|
| MSK | `https://77.105.169.97:31441/<basePath_MSK>` | `77.105.169.97.json` |
| SPB | `https://rus-panel.zyulkov.ru:8443/<basePath_SPB>` | `212.67.12.230.json` |
| EST | `https://est-panel.zyulkov.ru:8443/<basePath_EST>` | `38.180.164.100.json` |
...
- **Secrets:** токены/пароли только в `targets.json` (вне репо, `0600`). В логах
  токены редACTируются (`qeHhFJi4…`). `.gitignore` страхует `scripts/targets.json`
